...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-charcoal">
      ...
      <section className="py-20 bg-charcoal/50 border-y border-silver/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-silver/80">Worldwide network for exceptional aircraft acquisition opportunities</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-aviation-blue/20 flex items-center justify-center">
                <svg className="w-8 h-8 text-silver" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-charcoal/50 border-y border-silver/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-montserrat text-4xl font-bold text-off-white mb-6">Why Consider Pre-Owned Aircraft?</h2>
              <p className="text-silver/80 mb-6">
                Pre-owned aircraft offer exceptional value without compromising quality. Modern aircraft maintenance standards ensure longevity, while significant cost savings compared to new acquisitions allow for investment in higher-specification aircraft.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-gold mr-3">✓</span>
                  <span className="text-off-white/80">Immediate availability and deployment</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold mr-3">✓</span>
                  <span className="text-off-white/80">Proven track record and documented history</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold mr-3">✓</span>
                  <span className="text-off-white/80">Lower capital requirement for higher-tier aircraft</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold mr-3">✓</span>
                  <span className="text-off-white/80">Established support networks and parts availability</span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-montserrat text-4xl font-bold text-off-white mb-4">Speak with Our Aircraft Specialists</h2>
          <p className="text-silver mb-8 max-w-2xl mx-auto">
            Our experienced team provides personalised guidance through every step of the acquisition process. Contact us to discuss your requirements.
          </p>
          <Link 
            href="/contact" 
            className="inline-block bg-gold hover:bg-gold/90 text-charcoal font-semibold px-8 py-4 rounded text-lg transition-colors"
          >
            Get in Touch
          </Link>
        </div>
